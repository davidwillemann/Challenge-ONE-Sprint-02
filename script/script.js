...
const words = ['VERMELHO', 'ESTOJO', 'UMBIGO', 'TALHER', 'CUECA', 'RELUZENTE', 'NETUNO', 'AMENDOIM', 'FUTEBOL', 'COELHO'];
const tips = ['COR', 'UNTENSÍLIO', 'PARTE DO CORPO', 'OBJETO', 'ROUPA', 'ILUMINACAO', 'PLANETAS', 'COMIDA', 'ESPORTE', 'ANIMAL FOFINHO'];
...
function createBoard() {
    ...
    for(let i = 0; i < 6; i++) {
        hearts.children[i].src = './images/heart.png';
    }
    lossCount = 0;
    winCount = 0;
    keyPressed = [];
...
function heartLoss(points) {
    switch(points){
        case 1:
            hearts.children[5].src = './images/heart-death6.png';
            break;
        case 2:
            hearts.children[4].src = './images/heart-death5.png';
            break;
        case 3:
            hearts.children[3].src = './images/heart-death4.png';
            break;
        case 4:
            hearts.children[2].src = './images/heart-death3.png';
            break;
        case 5:
            hearts.children[1].src = './images/heart-death2.png';
            break;
        case 6:
            hearts.children[0].src = './images/heart-death1.png';
            lost();
            break;
    }
}
